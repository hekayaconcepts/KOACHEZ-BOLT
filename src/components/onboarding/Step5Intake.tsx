...
export default function Step5Intake({ data, updateData, onNext, onPrev }: Step5Props) {
  return (
    <div>
      ...
      <p style={{ fontSize: 14, color: '#6b7280', marginBottom: 32 }}>Collect information from clients before their first session.</p>

      <div style={{ background: '#f0f7ff', borderRadius: 12, padding: 32, textAlign: 'center', marginBottom: 32 }}>
        <div style={{ fontSize: 48, marginBottom: 12 }}>📋</div>
        <p style={{ fontSize: 14, color: '#6b7280', margin: 0 }}>Intake form builder coming soon. You can skip this for now.</p>
      </div>
